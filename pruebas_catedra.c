...
static void prueba_hash_borrar()
{
    ...
    print_test("Borrar 1", hash_borrar(hash, clave1) == valor1);
    print_test("borrar 2", hash_borrar(hash, clave2) == valor2);
    print_test("borrar 3", hash_borrar(hash, clave3) == valor3);
    print_test("La cantidad de elementos es 0", hash_cantidad(hash) == 0);
